    ...
    public function index()
    {
        ...
        foreach($dataRencana as $item) {
            ...
            if (!isset($summaryOutput[$key])) $summaryOutput[$key] = [
                'output' => $output,
                'kegiatan' => $kegiatan,
                'total_pagu'=>0, 'total_realisasi'=>0, 'total_rpd'=>0
            ];
        ...
        return view('dashboard.user', compact(
            'totalRencana', 'totalRealisasi', 'totalAkun', 'totalUraian',
            'totalPagu', 'totalRealisasiNominal', 'totalSelisih',
            'bulan', 'rencanaPerBulan', 'realisasiPerBulan',
            'tahun', 'chartLabels', 'chartDatasets',
            'summaryOutput', 'summaryUnitKerja', 'summaryJenisBelanja',
            'summaryJenisBelanjaBulan', 'summaryJenisBelanjaBulanRencana', 'bulanLabels'
        ));
    }
}
